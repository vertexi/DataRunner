...
Most flags are inherited by children dock spaces.
    ...
    std::array all_flags = {
        DockFlagWithInfo {ImGuiDockNodeFlags_NoSplit, "NoSplit", "prevent Dock Nodes from being split"},
        DockFlagWithInfo {ImGuiDockNodeFlags_NoResize, "NoResize", "prevent Dock Nodes from being resized"},
        DockFlagWithInfo {ImGuiDockNodeFlags_AutoHideTabBar, "AutoHideTabBar",
         "show tab bar only if multiple windows\n"
         "You will need to restore the layout after changing (Menu \"View/Restore Layout\")"},
        DockFlagWithInfo {ImGuiDockNodeFlags_NoDockingInCentralNode, "NoDockingInCentralNode",
